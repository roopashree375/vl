...
<h1 class="ui header" style="text-align:center" id = "head">
 ...
 <div class="twelve wide stretched column">
    <div class="ui segment">
      ...
      <div id="int">
      <h3>Deapth-First-Search</h3>  
      <p>Depth first search (DFS) algorithm starts with the initial node of the graph G, and then goes to deeper and deeper until we find the goal
           node or the node which has no children. The algorithm, then backtracks from the dead end towards the most recent node that is yet to be 
           completely unexplored.</p>
           <p>The data structure which is being used in DFS is stack. The process is similar to BFS algorithm. In DFS, the edges that
                leads to an unvisited node are called discovery edges while the edges that leads to an already
                visited node are called block edges.</p>
        <br><br>
        <iframe height="400px" width="100%" allowfullscreen="allowfullscreen" src="https://www.youtube.com/embed/uDWljP2PGmU" frameborder="0">
</iframe>
<br><br>
      </div>
