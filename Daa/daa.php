      ...
      <div class="twelve wide stretched column">
        <div class="ui segment">
          ...
          <div id="pre" style="display: none;">
            <p>1. The student will be able to understand and use asymptotic notation to formulate the time
          ...
          <div id="faqs" style="display: none;">
            <div class="ui styled accordion">
              ...
              <div class="title">
                <i class="dropdown icon"></i>what are the various types of algorithm methods used in machine learning?
              </div>
              <div class="content">
              ...
              <div class="title">
                <i class="dropdown icon"></i>different types of algorithm in data structure?
              </div>
              <div class="content">
