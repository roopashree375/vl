      ...
      <div id="pre" style="display: none;">
        ...
        <li> De Morgan has suggested two theorems which are extremely useful in Boolean Algebra.</li>
          <br><br>
            ...
            <div class="GrayBlock">
              <div class="item"><strong>Theorem 1:</strong><p>The left hand side (LHS) of this theorem represents a NAND gate with inputs A and B,whereas the right hand side (RHS) of the theorem represents an OR gate with inverted inputs. This OR gate is called as Bubbled OR.</p>
                  A.B = A+B     </div>
              <div class="item"><strong>Theorem 2:</strong><p> The LHS of this theorem represents a NOR gate with inputs A and B, whereas the RHS 
