...
<div id="toTop"><i class="chevron up icon"></i></div>
 ...
 <div class="twelve wide stretched column">
    <div class="ui segment">
      ...
      <div id="pre" style="display: none;"><p>1. Introduce principles and applications of Automata theory.</p>
      ...
      <div id="faqs" style="display: none;">
        <div class="ui styled accordion">
          ...
          <div class="title" >
            <i class="dropdown icon"></i>What is Formal Language? </div>
          <div class="content">
          ...
          <div class="title" >
            <i class="dropdown icon"></i>What is Equivalent Automata? </div>
          <div class="content">
          ...
          <div class="title" >
            <i class="dropdown icon"></i>What is Regular Expression? </div>
          <div class="content">
          ...
          <div class="title" >
            <i class="dropdown icon"></i>What is Context Free Grammar? </div>
          <div class="content">
