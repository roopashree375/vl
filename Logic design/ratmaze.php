 ...
 <div class="twelve wide stretched column">
    <div class="ui segment">
      ...
      <h3>Quine McCluskey Method</h3>
          In previous method, we discussed K-map, which is a convenient method for minimizing 
          Boolean functions up to 5 variables. But, it is difficult to simplify the Boolean functions having
          more than 5 variables by using this method.</p>
          <p>Quine-McCluskey method is a tabular method based on the concept of prime implicants. We 
          know that prime implicant is a product or sum term, which can’t be further reduced by 
          combining with any other product or sum terms of the given Boolean function.
          This tabular method is useful to get the prime implicants by repeatedly using the following 
          Boolean identity.</p>
          xy + xy’ = x(y+y′) = x.1 = x
        <br><br>
        <iframe height="400px" width="100%" allowfullscreen="allowfullscreen" src="https://www.youtube.com/embed/l1jgq0R5EwQ" frameborder="0">
</iframe>
<br><br>
      </div>
      ...
      <div id="pre" style="display: none;">
        <div class="ui bulleted list">
          <div class="item">
          <li>Procedure of Quine-McCluskey Tabular Method ,follow these steps for simplifying Boolean functions using Quine-McCluskey tabular method.</li>
          <br><br>
            
            <div class="GrayBlock">
            <h2> Rules of Minimization in K-Map</h2>
           <ol type="circle">
<li>  Arrange the given min terms in an ascending order and make the groups based on the 
...
equivalent of min terms.</li>
<li>Compare the min terms present in successive groups. If there is a change in only one-
bit position, then take the pair of those two min terms. Place this symbol ‘_’ in the differed bit 
position and keep the remaining bits as it is.</li>
<li>Repeat step2 with newly formed terms till we get all prime implicants.</li>
<li>Formulate the prime implicant table. It consists of set of rows and columns. Prime 
implicants can be placed in row wise and min terms can be placed in column wise. Place ‘1’ in 
the cells corresponding to the min terms that are covered in each prime implicant.</li>
<li>Find the essential prime implicants by observing each column. If the min term is 
covered only by one prime implicant, then it is essential prime implicant. Those essential 
prime implicants will be part of the simplified Boolean function.</li>
<li> Reduce the prime implicant table by removing the row of each essential prime 
...
min terms of given Boolean function are over.</li>        
        </ol>           </div>
              
            </div></div>
            <br>
            <img id="theoryImage" src="images/quine.png">
            <br>
            <div class="item">
            <li>The Quine–McCluskey algorithm is functionally identical to Karnaugh mapping, but the tabular form makes it more efficient for use in computer algorithms, and it also gives a deterministic way to check that the minimal form of a Boolean function has been reached. It is sometimes referred to as the tabulation method.</li>
            </div>
          </div>
          <br>
      </div>
