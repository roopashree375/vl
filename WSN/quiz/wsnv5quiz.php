...
<head>
    ...
    <title>Quiz on Contention based and Scheduled based Protocols</title>
...
<body>
    ...
    <div>
        ...
        <div>
            <h1>Quiz on Contention based and Scheduled based Protocols</h1>
        </div>
        <br>
        <br>
        <div class="qPanel" style="padding: 50px; height: 350px; line-height: 1.7rem;">
        ...
        <script src="wsnv5data.js"></script>
