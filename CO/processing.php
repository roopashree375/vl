...
<h1 class="ui header" style="text-align:center" id = "head">
 ...
 <div class="twelve wide stretched column">
    <div class="ui segment">
      ...
      <div id="int">
    <b>A short video depicting how a process occurs inside a system :</b> <br><br>
      <iframe height="400px" width="100%" allowfullscreen="allowfullscreen" src="https://www.youtube.com/embed/AkFi90lZmXA"  frameborder="0"></iframe>
      <br><br>
...
<button class="ui left floated button" onclick="myFunction()">Custom Input</button>
      ...
      <a href="quiz/processingquiz.php"><button id="quizbutton"><strong>Take a Quiz and Test your knowledge</strong></button></a>
        </div>
      </div>
      </div>
