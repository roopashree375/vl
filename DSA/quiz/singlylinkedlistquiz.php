...
<head>
    ...
    <title>Quiz On Singly Linked list</title>
...
<body>
    ...
    <div>
        <div class="ui  light grey inverted secondary huge menu">
            ...
            <a class="item" href="../singlylinkedlist.php">
                singlylinkedlist
            </a>
            <a class="item">
                About Us
        ...
        <div>
            <h1>QUIZ ON SINGLY LINKED LIST</h1>
        </div>
        <br>
        <br>
        <div class="qPanel" checked="false">
        ...
        <script src="singlylinkedlistdata.js"></script>
