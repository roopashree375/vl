        ...
        <div class="ui segment">
          ...
          <div id="lis" style="display: none;">
            <div class="ui bulleted list">
              ...
              <a class="item" href="./madv5.php">Mobile Application Security</a>
          ...
          <div id="faqs" style="display: none;">
            <div class="ui styled accordion">
              ...
              <div class="title">
                <i class="dropdown icon"></i> What is the Android SDK?
              </div>
              <div class="content">
              ...
              <div class="title">
                <i class="dropdown icon"></i>Name the languages supported for Android development.
              </div>
              <div class="content">
