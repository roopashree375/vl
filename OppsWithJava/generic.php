      ...
      <div class="twelve wide stretched column">
        <div class="ui segment">
          ...
          <div id="int">
            ...
            <iframe height="400px" width="100%" allowfullscreen="allowfullscreen" src="https://www.youtube.com/embed/XMvznsY02Mk">
            </iframe><br><br>
            In this program, you'll learn to use gerneric and meathods of stack
          </div>
        ...
        <input type="hidden" name="extra" value="Content of the extra variable" >
         ...
         <input type="hidden" name="prog" >
          ...
          <div id="faqs" style="display: none;">
            <a href="quiz/genericquiz.php"><button id="quizbutton"><strong>Take a Quiz and Test your knowledge</strong></button></a>
          </div>
        </div>
      </div>
