...
<head>
  ...
  <title>Operation on Threads</title>
...
<br><br>
In this program, you'll learn about thread and how do they run
      ...
      <div id="pre" style="display: none;">
        <div class="ui bulleted list">
          ...
          which is created by the Java Virtual Machine (JVM) at the program's start, when the main() method is invoked with the main thread.<br><br>
            
            <div class="GrayBlock">
            <br>
            <img id="theoryImage" src="../images/thread.png">
            <br>
            </div></div>
...
<button class="ui left floated button" onclick="myFunction()">Custom Input</button>
      ...
      <a href="quiz/threadsquiz.php"><button id="quizbutton"><strong>Take a Quiz and Test your knowledge</strong></button></a>
        </div>
      </div>
      </div>
