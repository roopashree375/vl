...
In this program, you'll learn to find the basic use in Java.
      ...
      <div id="pre" style="display: none;">
        <div class="ui bulleted list">
          <div class="item">
          Formula To calculate Gross income & Net Deductions<br>
            <div class="GrayBlock">
              <div class="item"><strong>Gross income:</strong>Basic + DA + HRA + CCA</div>
              <div class="item"><strong> Deductions:</strong> PF+PT+IT</div>
              <div class="item"><strong>Net income:</strong>Gross income – Deductions</div>
            </div>
            </div>
            <!-- <div class="item">
...
<button class="ui left floated button" onclick="myFunction()">Custom Input</button>
      ...
      <a href="quiz/grossnetsalaryquiz.php"><button id="quizbutton"><strong>Take a Quiz and Test your knowledge</strong></button></a>
        </div>
      </div>
      </div>
